...
session_start();
 ...
 if(isset($_POST['sendDocument']) && $_POST['sendDocument'] == 'Send Document' && isset($_GET['riskId']))
 {
    ...
    if(isset($_POST['NotifySignatureAdded'] ) && $_POST['NotifySignatureAdded'] == 'on')
    {
    ...
    if(isset($_POST['whenViewed']) && $_POST['whenViewed'] == 'on')
    {
      $whenViewed = 1;
    }
    else
    ...
    if(isset($_POST['whenSignatureAdded']) && $_POST['whenSignatureAdded'] == 'on')
    {
    ...
    if(isset($_POST['sendAttachment']) && $_POST['sendAttachment'] == 'on')
    {
      $sendAttachment = 1;
    }
    else
    ...
    if(isset($_POST['signingReminders']) && $_POST['signingReminders'] == 'on')
    {
      $signingReminders = 1;
    }
    else
    {
     ...
     $update = "UPDATE `riskassessment` SET `NotifySignatureAdded` = '".$NotifySignatureAdded."', `whenViewed` = '".$whenViewed."', `whenSignatureAdded` = '".$whenSignatureAdded."', `sendAttachment` = '".$sendAttachment."', `signingReminders` = '".$signingReminders."', `sendReminder` = '".$_POST['sendReminder']."', `afterFirstReminder` = '".$_POST['afterFirstReminder']."', `ecpireReminder` = '".$_POST['ecpireReminder']."' , `status` = '0' WHERE `id` = ".$_GET['riskId']."";
