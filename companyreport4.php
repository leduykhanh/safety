...
<div class="page">
    ...
    //number of hazards in workactivity
        ...
        <tr>
            ...
            <td rowspan="1" colspan="1" style="text-align: left;white-space:pre;max-width:300px">  <?php foreach($resultAllHazardCauses as $cause) echo wordwrap($cause["cause"],20,"\n",1); ?></td>
           ...
           <td rowspan="1" colspan="1"><?php echo $RPNLabel;?></td>
             <td rowspan="1" colspan="5" style="text-align: left;white-space:pre">  <?php echo wordwrap ($hzardsValue['risk_control'], 30, "\n", 1);?></td>
