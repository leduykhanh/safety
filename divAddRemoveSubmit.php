      ...
      <div class="col-sm-12 form_pad">
                ...
                <div class="col-sm-12 form-row">
                          <div class="col-sm-6">
                            ...
                            <label class="col-sm-8">
                              <textarea rows="2" name="location" class="span4" type="text" id="inputSaving" placeholder="" ></textarea></label>
                          </div>
                          ...
                          <div class="col-sm-6">
                            ...
                            <label class="col-sm-8">
                               <input name="creationDate" class="span4 date" type="text" id="creationDate" placeholder="" ></label>
                ...
                <div class="col-sm-12 form-row">
                            <div class="col-sm-6">
                              ...
                              <label class="col-sm-8">
                                <textarea rows="2" name="process" class="span4" type="text" id="inputSaving" placeholder="" ></textarea>
                              </label>
                            </div>
                            <div class="col-sm-6">
                  ...
                  <div class="col-sm-12 hazardSection hazardSectionCopy">
                        ...
                        <div class="col-sm-6 form-row">
                          ...
                          <div class="form-row">
                            ...
                            <input name="actionDate[]" class="col-sm-6" type="text"  placeholder="" >
<!--                             <select class="col-sm-2 btn btn-default" id="inputSaving" name="actionDate[]">
                       ...
                       <div class="col-sm-12 form-row">
                             <input type="hidden" name="hazardsActionOfficerCount[]" id="hazardsActionOfficerCount" value="0" />
                                ...
                                <div id="action_officer" class="row repeatingActionOfficer">
